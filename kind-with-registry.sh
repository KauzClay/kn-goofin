...
- role: worker
  image: kindest/node:v1.20.2@sha256:8f7ea6e7642c0da54f04a7ee10431549c0257315b3a634f6ef2fecaaedb19bab
  extraPortMappings:
  - containerPort: 31443 # expose port 31443 of the node to port 80 on the host, later to be use by Contour ingress (envoy)
    hostPort: 443
  - containerPort: 31080 # expose port 31080 of the node to port 80 on the host, later to be use by Contour ingress (envoy)
    hostPort: 80
